...
const AuthLayout = ({children}) => {
  return (
    <div className='flex'>
         ...
         <div className='hidden md:block w-[60vw] h-screen bg-violet-50 g-cover bg-no-repeat bg-center p-8 relative overflow-hidden'>
            ...
            <div className='grid grid-cols-1 z-20'>
              ...
              label='Track Your Income & Expenses' value='430, 000' color= 'bg-[#9333ea]' />
            </div>
            <img src={chart} alt="auth-banner" className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15'/>
         </div>
    </div>
  )
}
